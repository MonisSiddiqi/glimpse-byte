        ...
        <div className="w-full flex flex-col gap-2 max-w-[40rem]">
            <div className="w-full flex gap-2">
                <Avatar className="size-24 rounded-sm overflow-hidden">
                    <AvatarImage src={pagePhoto} crossOrigin="anonymous" className="object-cover rounded-none" />
                    <AvatarFallback className="rounded-none">{getInitials("BASF Dubai")}</AvatarFallback>
                </Avatar>
                <div className="flex flex-col gap-1 w-full">
                    <div className="flex justify-between">
                        <p className="text-gray-700 text-xl font-medium">{name}</p>
                        <Button className="bg-basf-blue hover:bg-basf-blue/80">Unfollow</Button>
                    </div>
